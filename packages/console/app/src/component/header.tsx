...
import copyLogoSvgLight from "../asset/lander/tasia-logo-light.svg"
import copyLogoSvgDark from "../asset/lander/tasia-logo-dark.svg"
import copyWordmarkSvgLight from "../asset/lander/tasia-wordmark-light.svg"
import copyWordmarkSvgDark from "../asset/lander/tasia-wordmark-dark.svg"
  ...
  return (
    <section data-component="top">
      <div onContextMenu={handleLogoContextMenu}>
        <A href="/">
          <img data-slot="logo light" src={logoLight} alt="tasia logo light" width="189" height="34" />
          <img data-slot="logo dark" src={logoDark} alt="tasia logo dark" width="189" height="34" />
        </A>
      </div>
