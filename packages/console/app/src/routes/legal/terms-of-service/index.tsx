...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>Tasia | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="Tasia terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Tasia. Please read on to learn the rules and restrictions that govern your use of Tasia
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Tasia," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-tasia">What is Tasia?</h2>
              <p>
                Tasia is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Tasia Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Tasia enables you to
              ...
              <p>
                Tasia takes the privacy of its users very seriously. For the current Tasia Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using Tasia?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Tasia;
                </li>
                <li>
              ...
              <p>
                If you use Tasia with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Tasia. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Tasia has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-tasia-ever-change-the-services">Will Tasia ever change the Services?</h2>
              <p>
              ...
              <p>
                Tasia is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Tasia has the sole right to decide whether you are
              ...
              <p>
                Tasia and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Tasia and all such
                parties together, the "Tasia Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Tasia Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Tasia Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY TASIA (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                TASIA PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO TASIA IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Tasia Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Tasia's prior written
              ...
              <p>
                ...
                disputes and claims with Tasia and limits the manner in which you can seek relief from Tasia. Both
                you and Tasia acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Tasia's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Tasia will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Tasia will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Tasia may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND TASIA WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Tasia are instead choosing to have claims and disputes resolved by
                ...
                you and Tasia over whether to vacate or enforce an arbitration award, YOU AND TASIA WAIVE ALL
              ...
              <p>
                ...
                Tasia is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Tasia to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Tasia agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Tasia may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Tasia agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Tasia, and
                ...
                are not an employee, agent, partner, or joint venture of Tasia, and you do not have any authority of
                any kind to bind Tasia in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Tasia
