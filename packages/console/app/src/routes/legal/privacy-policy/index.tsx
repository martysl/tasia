...
export default function PrivacyPolicy() {
  return (
    <main data-page="legal">
      <Title>Tasia | Privacy Policy</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/privacy-policy`} />
      <Meta name="description" content="Tasia privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Tasia, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Tasia is at all times subject to our Terms of Use,{" "}
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Tasia website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Tasia.
                </li>
              ...
              <p>
                ...
                you, Tasia or another party; enforcing any agreements with you; responding to claims that any posting
