...
import { Database, eq, and, isNull, sql } from "@tasia-ai/console-core/drizzle/index.js"
import { BillingTable, SubscriptionTable } from "@tasia-ai/console-core/schema/billing.sql.js"
import { Actor } from "@tasia-ai/console-core/actor.js"
import { Black } from "@tasia-ai/console-core/black.js"
          ...
          <section class={styles.root}>
            <div data-slot="section-title">
              ...
              <div data-slot="title-row">
                <p>You are subscribed to Tasia Black for ${sub().plan} per month.</p>
                <button
                  data-color="primary"
            ...
            <div data-slot="title-row">
              <p>
                {billing()?.timeSubscriptionSelected
                  ? `We're ready to enroll you into the $${billing()?.subscriptionPlan} per month Tasia Black plan.`
                  : `You are on the waitlist for the $${billing()?.subscriptionPlan} per month Tasia Black plan.`}
              </p>
              <button
                data-color="danger"
