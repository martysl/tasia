...
import { Keybind } from "@tasia-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const centerMount = createMemo(() => document.getElementById("tasia-titlebar-center"))
  const rightMount = createMemo(() => document.getElementById("tasia-titlebar-right"))
