...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@tasia-ai/ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  onMount(() => {
    const run = async () => {
      ...
      if (window.__TASIA__?.serverPassword) {
        url.username = "tasia"
        url.password = window.__TASIA__?.serverPassword
      }
