...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Tasia",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Tasia.",
  ...
  "provider.connect.tasiaZen.line1":
    "Tasia Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.tasiaZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.tasiaZen.visit.prefix": "Besøk ",
  "provider.connect.tasiaZen.visit.link": "opencode.ai/zen",
  "provider.connect.tasiaZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Tasia.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Tasia.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i tasia.json",
  ...
  "dialog.server.description": "Bytt hvilken Tasia-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Tasia ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Tasia-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (tasia.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Tasia ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Tasia inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Tasia",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Tasia ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Tasia er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Tasia starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Tasia.",
