...
export const dict = {
  ...
  "dialog.provider.tasia.note": "使用 Tasia Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasia 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Tasia 中使用 {{provider}} 模型。",
  ...
  "provider.connect.tasiaZen.line1": "Tasia Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.tasiaZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.tasiaZen.visit.prefix": "访问 ",
  "provider.connect.tasiaZen.visit.link": "opencode.ai/zen",
  "provider.connect.tasiaZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Tasia 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Tasia 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 tasia.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Tasia 服务器。",
  ...
  "toast.update.description": "Tasia 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Tasia 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (tasia.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Tasia 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Tasia 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Tasia 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Tasia 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Tasia 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Tasia 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Tasia。",
