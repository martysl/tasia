...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Tasia",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Tasia zu nutzen.",
  ...
  "provider.connect.tasiaZen.line1":
    "Tasia Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.tasiaZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.tasiaZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.tasiaZen.visit.link": "opencode.ai/zen",
  "provider.connect.tasiaZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Tasia zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Tasia zu nutzen.",
  ...
  "dialog.plugins.empty": "In tasia.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Tasia-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Tasia ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Tasia-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (tasia.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Tasia unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Tasia enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Tasia Desktop",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Tasia ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Tasia auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Tasia anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Tasia automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Tasia.",
