...
description: What's new in Tasia 1.0.
---

Tasia 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same tasia server.
...
version. However some older versions of Tasia always grab latest.
