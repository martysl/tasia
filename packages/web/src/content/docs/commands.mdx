...
Create `.tasia/commands/test.md`:

```md title=".tasia/commands/test.md"
---
...
You can add custom commands through the Tasia config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Tasia [config](/docs/config):

```json title="tasia.jsonc" {4-12}
{
...
- Global: `~/.config/tasia/commands/`
- Per-project: `.tasia/commands/`

```markdown title="~/.config/tasia/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".tasia/commands/component.md"
---
...
```md title=".tasia/commands/create-file.md"
---
...
```md title=".tasia/commands/analyze-coverage.md"
---
...
```md title=".tasia/commands/review-changes.md"
---
...
```md title=".tasia/commands/review-component.md"
---
...
tasia includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
