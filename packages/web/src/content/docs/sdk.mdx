---
title: SDK
description: Type-safe JS client for tasia server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The tasia JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control tasia programmatically.
...
Create an instance of tasia:

```javascript
import { createTasia } from "@tasia-ai/sdk"

const { client } = await createTasia()
```
...
You can pass a configuration object to customize behavior. The instance still picks up your `tasia.json`, but you can override or add configuration inline:
...
console.log(`Server running at ${tasia.server.url}`)
...
If you already have a running instance of tasia, you can create a client instance to connect to it:
...
```typescript
import type { Session, Message, Part } from "@tasia-ai/sdk"
```
