---
title: Zen
description: Curated list of models provided by Tasia.
---
...
Tasia Zen is a list of tested and verified models provided by the Tasia team.

:::note
Tasia Zen is currently in beta.
:::

Zen works like any other provider in Tasia. You login to Tasia Zen and get
...
:::tip
We tested a select group of models and providers that work well with Tasia.
:::
...
Tasia Zen is an AI gateway that gives you access to these models.

---

## How it works

Tasia Zen works like any other provider in Tasia.

1. You sign in to **<a href={console}>Tasia Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Tasia Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Tasia config
uses the format `tasia/<model-id>`. For example, for GPT 5.2 Codex, you would
use `tasia/gpt-5.2-codex` in your config.
...
- GLM 4.7 Free is available on Tasia for a limited time. The team is using this time to collect feedback and improve the model.
- Kimi M2.5 Free is available on Tasia for a limited time. The team is using this time to collect feedback and improve the model.
- MiniMax M2.1 Free is available on Tasia for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Tasia for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Tasia as well.
