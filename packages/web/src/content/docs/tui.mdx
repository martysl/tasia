---
title: TUI
description: Using the Tasia terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Tasia provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Tasia starts the TUI for the current directory.
...
When using the Tasia TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Tasia. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Tasia config file.
