...
const mockPlugin = () => ({})
mock.module("tasia-copilot-auth", () => ({ default: mockPlugin }))
mock.module("tasia-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/tasia-gitlab-auth", () => ({ default: mockPlugin }))
