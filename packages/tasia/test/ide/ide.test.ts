...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TASIA_CALLER", () => {
    process.env["TASIA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TASIA_CALLER", () => {
    process.env["TASIA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TASIA_CALLER", () => {
    process.env["TASIA_CALLER"] = "unknown"
