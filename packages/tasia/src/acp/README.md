...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for tasia.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal tasia sessions
...
- **Terminal Integration**: Full terminal support via tasia's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | tasia acp
```
...
ACP sessions map cleanly to tasia's internal session model:
