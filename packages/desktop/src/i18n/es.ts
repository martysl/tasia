export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Tasia",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Tasia. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'tasia'.",
  "desktop.cli.failed.title": "Instalación fallida",
  "desktop.cli.failed.message": "No se pudo instalar la CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Tasia no pudo iniciarse",
  "desktop.error.serverStartFailed.description":
    "No se pudo iniciar el servidor local de Tasia. Reinicia la aplicación o revisa tu configuración de red (VPN/proxy) y vuelve a intentarlo.",
}
