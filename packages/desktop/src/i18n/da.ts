export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Tasia",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Tasia er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'tasia'-kommandoen.",
  ...
  "desktop.error.serverStartFailed.description":
    "Den lokale Tasia-server kunne ikke startes. Genstart appen, eller tjek dine netværksindstillinger (VPN/proxy) og prøv igen.",
}
