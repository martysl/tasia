export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Tasia",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Tasia wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'tasia' zu verwenden.",
  "desktop.cli.failed.title": "Installation fehlgeschlagen",
  "desktop.cli.failed.message": "CLI konnte nicht installiert werden: {{error}}",

  "desktop.error.serverStartFailed.title": "Tasia konnte nicht gestartet werden",
  "desktop.error.serverStartFailed.description":
    "Der lokale Tasia-Server konnte nicht gestartet werden. Starten Sie die App neu oder überprüfen Sie Ihre Netzwerkeinstellungen (VPN/Proxy) und versuchen Sie es erneut.",
}
