export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Tasia",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Tasia. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'tasia'.",
  "desktop.cli.failed.title": "Instalacja nie powiodła się",
  "desktop.cli.failed.message": "Nie udało się zainstalować CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Nie udało się uruchomić Tasia",
  "desktop.error.serverStartFailed.description":
    "Nie udało się uruchomić lokalnego serwera Tasia. Uruchom ponownie aplikację lub sprawdź ustawienia sieciowe (VPN/proxy) i spróbuj ponownie.",
}
