...
import { AppBaseProviders, AppInterface, PlatformProvider, Platform } from "@tasia-ai/app"
...
import { Splash } from "@tasia-ai/ui/logo"
...
const emitDeepLinks = (urls: string[]) => {
  ...
  window.__TASIA__.deepLinks = [...pending, ...urls]
...
const createPlatform = (password: Accessor<string | null>): Platform => ({
  ...
  fetch: (input, init) => {
    ...
    const addHeader = (headers: Headers, password: string) => {
      headers.append("Authorization", `Basic ${btoa(`tasia:${password}`)}`)
    }
      ...
      <AppBaseProviders>
        <ServerGate>
          {(data) => {
            ...
            window.__TASIA__ ??= {}
            window.__TASIA__.serverPassword = data().password ?? undefined
