...
const CLI_INSTALL_DIR: &str = ".tasia/bin";
const CLI_BINARY_NAME: &str = "tasia";
...
pub fn install_cli(app: tauri::AppHandle) -> Result<String, String> {
    ...
    let temp_script = std::env::temp_dir().join("tasia-install.sh");
...
pub fn create_command(app: &tauri::AppHandle, args: &str) -> Command {
    ...
    return app
        ...
        .env("TASIA_EXPERIMENTAL_ICON_DISCOVERY", "true")
        .env("TASIA_EXPERIMENTAL_FILEWATCHER", "true")
        .env("TASIA_CLIENT", "desktop")
