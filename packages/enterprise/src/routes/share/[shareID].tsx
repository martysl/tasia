import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@tasia-ai/sdk/v2"
...
import { DiffComponentProvider } from "@tasia-ai/ui/context/diff"
import { CodeComponentProvider } from "@tasia-ai/ui/context/code"
import { WorkerPoolProvider } from "@tasia-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@tasia-ai/ui/logo"
import { IconButton } from "@tasia-ai/ui/icon-button"
import { ProviderIcon } from "@tasia-ai/ui/provider-icon"
import { createDefaultOptions } from "@tasia-ai/ui/pierre"
...
import { Diff as SSRDiff } from "@tasia-ai/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@tasia-ai/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@tasia-ai/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@tasia-ai/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@tasia-ai/ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Tasia</Title>
              </Show>
              <Meta name="description" content="tasia - The AI coding agent built for the terminal." />
