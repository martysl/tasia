...
const STORAGE_KEYS = {
  THEME_ID: "tasia-theme-id",
  COLOR_SCHEME: "tasia-color-scheme",
  THEME_CSS_LIGHT: "tasia-theme-css-light",
  THEME_CSS_DARK: "tasia-theme-css-dark",
} as const

const THEME_STYLE_ID = "tasia-theme"
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  document.getElementById("tasia-theme-preload")?.remove()
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string }) => {
    const [store, setStore] = createStore({
      ...
      themeId: props.defaultTheme ?? "tasia-1",
