...
console.log("Fetching GitHub releases for anomalyco/tasia...\n")
...
console.log("Fetching npm all-time downloads for tasia-ai...\n")
const npmDownloads = await fetchNpmDownloads("tasia-ai")
